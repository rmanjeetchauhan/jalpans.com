              ...
              <div class="registercont card">
                ...
                <form class="login-form" id="formLogin" name="formLogin">
                  ...
                  <div class="imgcont text-center logo">
                    ...
                    <div class="hotel-title">DELIVERY BOY LOGIN</div>
                  </div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
        ...
        $('#formLogin').on('submit', function(e){       
            ...
            // $('#myloader').show();
            $.ajax({
                url: '<?php echo $deliveryBoyScript; ?>login.php',
                type: "POST",
                ...
                success: function (data) { 
                    ...
                    if(data == "success"){
                        ...
                        window.location.href = '<?php echo $deliveryBoyRedirect; ?>dashboard';
                        return true;
                    }
      ...
      function verifyMobileNo(){
        ...
        $('#modalmsg').html('Please wait...');
              ...
              $.ajax({
                  url: '<?php echo $deliveryBoyScript; ?>forgot-password-send-otp.php',
                  type: "POST",
                   data: {
                      phone: phone
                  },
      ...
      function verifyEnteredOtp(){
        ...
        $('#modalmsg').removeClass(' alert alert-danger');
            ...
            $.ajax({
                url: '<?php echo $deliveryBoyScript; ?>forgot-password-otp-validation.php',
                type: "POST",
                data: {
                    phone: phone,
                    otp: otp,
