...
$service_url = $apiurl."getAgentBankAccountRequest";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          ...
          <div class="titlecont">
            <div class="row">
              <div class="col-md-9"> <h1>  Request To change Agent Bank Account </h1> </div>
              <div class="col-md-3">                 
                 <form id="searchform">
                      ...
                      if(count($has_account_req) > 0){
                        for ($i=0; $i < count($has_account_req); $i++) { 
                          ...
                          if($has_account_req[$i]['status'] == 2){
                           ...
                           $profileUrl = $superAdminRedirect."agent-wallet-history/".$has_account_req[$i]['username']."/".$has_account_req[$i]['shop_agent_code'];

                      ?>
                        <tr class="<?php echo $class; ?>">

                           <td> 
                            <div><b> <a target="_blank" href="<?php echo $profileUrl; ?>"><?php echo strtoupper($has_account_req[$i]['name']); ?></a> </b></div>
                            <div> <i class="fa fa-map-phone"></i> <?php echo strtoupper($has_account_req[$i]['phone']); ?> </div>
                          </td>
    ...
    $(function(){
      ...
      <script type="text/javascript">
         ...
         $('#formAccountStatus').on('submit', function(e){       
            ...
            // $('#myloader').show();
            $.ajax({
                url: '<?php echo $superAdminScript;?>agent-bank-account-action.php',
                type: "POST",
