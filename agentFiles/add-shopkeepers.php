...
// $curl_post_data = array(
//   "api_key" => $api_key,
//   "shop_agent_id" => $_SESSION['shop-agent']['id'],
//   "status" => 0
// );
            ...
            <div class="card">
              <div class="row">                 
                 <div class="col-md-12">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input id="txtagentid" name="txtagentid" type="hidden" value="<?php echo $_SESSION['shop-agent']['id']; ?>" required>
                        </div>
                      </div>
                     ...
                     <div class="col-md-6">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea id="txtfulladdress" name="txtfulladdress" class="form-control" required></textarea>
                        </div>                        
                      </div>  
                  ...
                  <div class="text-center"><input type="button" class="btn btn-primary" value="Submit" id="validate-phone" name="validate-phone"></div>
