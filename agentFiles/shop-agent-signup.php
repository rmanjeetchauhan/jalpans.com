                ...
                <div class="registercont">
                  ...
                  <form id="registerShopkeeper" name="registerShopkeeper" enctype="multipart/form-data">
                   ...
                   <div class="imgcont text-center logo">
                    ...
                    <div class="hotel-title">SHOP AGENT SIGNUP</div>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group ">
                          <label class="control-label">CONTACT NUMBER2 <small>(optional)</small> </label>
                          <input id="txtphone2" name="txtphone2" type="text" class="form-control" pattern="[6789][0-9]{9}" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label">EMAIL ID <small>(optional)</small> </label>
                          <input id="txtemail" name="txtemail" type="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
                        </div>                        
                      </div>
                       <div class="clearfix"></div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                         <label class=""> <input id="txttermscondition" name="txttermscondition" type="checkbox" required> Click to accept our <a href="">Terms & Conditions</a><span>*</span></label>
                        </div>                        
                      </div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
        ...
        function verifyMobileNo(){
          ...
          $.ajax({
                url: '<?php echo $shopAgentScript; ?>verify-mobile-send-otp.php',
                type: "POST",
                 data: {
                    phone: phone,
                    email: email
        ...
        function VerifyMobileOTP(){
          ...
          $.ajax({
                url: '<?php echo $shopAgentScript; ?>verify-send-otp.php', 
                type: "POST",
                 data: {
                    phone: phone,
                    otp: otp,
