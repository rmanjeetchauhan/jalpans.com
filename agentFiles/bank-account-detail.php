...
include('url.php');
$service_url = $apiurl."getAgentBankAccount";
              ...
              <form id="formNewAccountRequest" name="formNewAccountRequest"> 
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      ...
                      <input type="hidden" name="txtuserid" id="txtuserid" value="<?php echo $_SESSION['shop-agent']['id']; ?>">
                    </div>
    ...
    <script src="<?php echo $vendorAssets; ?>js/main.js"></script>
      ...
      <script type="text/javascript"> 
        ...
        $('#formNewAccountRequest').on('submit', function(e){       
            ...
            // $('#myloader').show();
            $.ajax({
                url: '<?php echo $shopAgentScript; ?>change-bank-account.php',
                type: "POST",
