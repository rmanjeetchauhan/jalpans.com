...
include('url.php');
$service_url = $apiurl."getAgentShopkeepers";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div >
            <h1> Shopkeepers
              <a class="btn btn-primary btn-sm pull-right" href="<?php echo $shopAgentRedirect?>add-shopkeeper"> Add Shopkeeper </a>
            </h1>
          </div>
        </div>
        <div class="row">
                    ...
                    <tbody>
                        ...
                        if($has_data != 'error'){
                            ...
                            for ($i=0; $i < count($has_data); $i++) {
                              ...
                              $profileUrl = $shopAgentRedirect."shopkeeper-profile/".$has_data[$i]['username']."/".$has_data[$i]['shopcode'];
