              ...
              <div class="registercont card">
                ...
                <form class="login-form" id="formLogin" name="formLogin">
                  ...
                  <div class="imgcont text-center logo">
                    ...
                    <div class="hotel-title">SHPOKEEPER LOGIN</div>
                  </div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
        ...
        $('#formLogin').on('submit', function(e){       
            ...
            // $('#myloader').show();
            $.ajax({
                url: '<?php echo $vendorScript; ?>login.php',
                type: "POST",
      ...
      function verifyMobileNo(){
        ...
        $('#modalmsg').html('Please wait...');
              ...
              $.ajax({
                  url: '<?php echo $vendorScript; ?>forgot-password-send-otp.php',
                  type: "POST",
                   data: {
                      phone: phone
                  },
      ...
      function verifyEnteredOtp(){
        ...
        $('#modalmsg').removeClass(' alert alert-danger');
            ...
            $.ajax({
                url: '<?php echo $vendorScript; ?>forgot-password-otp-validation.php',
                type: "POST",
                data: {
                    phone: phone,
                    otp: otp,
