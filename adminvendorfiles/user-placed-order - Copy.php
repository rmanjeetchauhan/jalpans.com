...
// echo "<br>".$ip_address = $_SERVER['REMOTE_ADDR'];
                        ...
                        if($has_data != 'error'){
                            ...
                            for ($i=0; $i < count($has_data); $i++) {
                              ...
                              else if( $has_data[$i]['order']['order_status'] == 3){
                                   $cls = "btn-success";
                              }
                              else if( $has_data[$i]['order']['order_status'] == 4){
                                   $cls = "btn-danger";
                              }
                        ...
                        <tr >
                            ...
                            <td> <?php echo $has_data[$i]['order']['phone']; ?> </td>
                             <td> <button class="btn btn-xs <?php echo $cls; ?>" data-order="<?php echo $has_data[$i]['order']['order_id']; ?>" 
                              data-toggle="modal" data-target="#modalChangeStatus" onclick="$('#txtorderid').val($(this).attr('data-order'))" >
                                  <i class="fa fa-exchange"></i>&nbsp; <?php echo $has_data[$i]['order']['order_text']; ?> 
                                </button></td>
                            <!-- <td> <?php echo $has_data[$i]['order']['order_status']; ?> </td> -->
                          ...
                          <tr>
                            ...
                            <td colspan="2"> <?php echo $has_data[$i]['products'][$j] ['name']; ?> </td>
                         ...
                         <tr class="footrtbl">
                            ...
                            <td colspan="3" class="text-right"> <b>Owner : </b><?php echo $has_data[$i]['order']['name']."[".$has_data[$i]['order']['shopcontact']."]"; ?> </td>
